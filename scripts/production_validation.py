        ...
        try:
            ...
            entry = {
                ...
                **{key: 0.0 for key in _SCORE_KEYS}, "overall_score": 0.0, "recommendation": "ERROR",
                "status": "exception",
                "research_status": "unknown", "mvp_status": "unknown", "build_status": "unknown",
...
def write_idea_scorecard_csv(scorecard: list[dict[str, Any]], path: Path) -> None:
    fieldnames = [
        ...
        "research_status", "mvp_status", "build_status", "deployment_status", "growth_status",
...
<main><table>
<tr><th>#</th><th>Idea</th><th>Overall Score</th><th>Recommendation</th><th>Research</th><th>MVP</th><th>Build</th><th>Deploy</th><th>Growth</th><th>Top Reason / Error</th><th>Time</th></tr>
{rows}
</table></main>
