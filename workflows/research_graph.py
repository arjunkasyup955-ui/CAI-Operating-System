...
def build_research_graph() -> StateGraph:
    """Research Supervisor subgraph. Component 4 adds the Market Intelligence Agent
    after Browser - Competitor Analysis/Trend Detection/Opportunity Detection/Idea
    ...
    graph.add_edge("market_intelligence", END)
    return graph
