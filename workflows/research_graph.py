...
def build_research_graph() -> StateGraph:
    """Research Supervisor subgraph. Component 7 adds the Opportunity Detection Agent
    after Trend Intelligence - Idea Validation workers each land here as their own
    ...
    graph.add_edge("opportunity_detection", END)
    return graph
