...
def build_research_graph() -> StateGraph:
    """Research Supervisor subgraph. Component 6 adds the Trend Intelligence Agent
    after Competitor Intelligence - Opportunity Detection/Idea Validation workers each
    land here as their own component, extending this same internal graph. The
    Supervisor's external contract (its manifest, and how main_graph.py composes it)
    is unchanged.
    """
    ...
    graph.add_edge("trend_intelligence", END)
    return graph
